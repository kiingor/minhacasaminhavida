...
import { Users, TrendingUp, PieChart, ArrowUpRight, ArrowDownRight, Minus, ArrowUpCircle, ChevronDown, ChevronUp, Wallet, Layers } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        title="Relatórios"
        subtitle="Análise detalhada das finanças"
        actions={<MonthSelector mes={mes} onChange={setMes} />}
      />
